...
function Getappo() {
  ...
  data-aos-duration="800">
        ...
        and motivated</h1>
        <button className='bg-black text-white px-18 py-5 rounded-xl text-2xl font-semibold mt-5 hover:bg-gray-300 hover:text-black cursor-pointer'>Get Appointment</button>
    </div>
  )
}
