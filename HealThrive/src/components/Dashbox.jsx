...
function Dashbox() {
  ...
  data-aos-duration="800">
        ...
        <div className="bg-black shadow-xl/75 rounded-xl md:rounded-4xl m-4 p-6 w-40 md:p-12 md:w-[20rem] text-center text-white cursor-pointer hover:scale-105 transition-transform duration-300">
