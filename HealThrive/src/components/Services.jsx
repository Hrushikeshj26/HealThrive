...
function Services() {
  ...
  data-aos-duration="800" >
      {servicesData.map((service, index) => (
        <div key={index} className="shadow-xl/40 bg-white border-1 rounded-lg m-4 p-6 w-[20rem] md:w-[25rem] text-center hover:shadow-emerald-600 transition-shadow duration-200 cursor-pointer">
