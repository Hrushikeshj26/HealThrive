...
function Testimonials() {
  ...
  return (
    <div className="h-[30rem] md:min-h-[70vh] w-full flex flex-col items-center justify-center">
    ...
    <div className="relative w-full max-w-6xl mx-auto flex flex-col items-center justify-center">
      <div className="w-96 md:w-full max-w-4xl flex items-center justify-center">
        ...
        >
          {/* Slides */}
          <SwiperSlide className="p-4 md:p-14 bg-white rounded-3xl border-2">
            ...
            <SwiperSlide className="p-4 md:p-14 bg-white rounded-3xl border-2">
                ...
                <p className="text-gray-700 mb-4 md:text-xl">
                "The team at HealThrive is amazing! They listened to my concerns and provided personalized care that made a real difference."
                </p>
            </SwiperSlide>
            <SwiperSlide className="p-4 md:p-14 bg-white rounded-3xl border-2">
                <div className="flex items-center mb-6">
